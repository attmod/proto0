...
class ProcessingModule : public RFModule, public rpc_IDL {
    ...
    BufferedPort<yarp::sig::PointCloud<DataXYZRGBA>> responsePort; // out: vector xyz where we are fixated
    ...
    bool configure(ResourceFinder& rf) override {
        ...
        const string name = "micro_segment";
    ...
    bool updateModule() override {
        ...
        if( segment() ) { // loads images, spits out pc_object
            ...
            tableFix.clear();
            tableFix.addFloat64( table_height );
            tablePort.write();
        }
